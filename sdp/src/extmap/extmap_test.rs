...
fn test_extmap() -> Result<(), Error> {
    let example_attr_extmap1_line =
        format!("{}{}{}", ATTRIBUTE_KEY, EXAMPLE_ATTR_EXTMAP1, END_LINE);
    let example_attr_extmap2_line =
        format!("{}{}{}", ATTRIBUTE_KEY, EXAMPLE_ATTR_EXTMAP2, END_LINE);
