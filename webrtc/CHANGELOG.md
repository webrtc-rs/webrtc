...
* Added a new `write_rtp_with_extensions` method to `TrackLocalStaticSample` and `TrackLocalStatiRTP`.
...
* Changed `TrackLocal::write_rtp` to take ownership of the `pkt` parameter instead of taking it by reference.
