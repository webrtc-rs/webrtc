    ...
    let tests = vec![
        (
            CandidateBase {
                ...
                component: Arc::new(AtomicU16::new(COMPONENT_RTP as u16)),
                ..Default::default()
            },
            2130706431,
        ),
        (
            CandidateBase {
                candidate_type: CandidateType::Host,
                component: Arc::new(AtomicU16::new(COMPONENT_RTP as u16)),
                network_type: Arc::new(AtomicU8::new(NetworkType::Tcp4 as u8)),
        ...
        (
            CandidateBase {
                candidate_type: CandidateType::PeerReflexive,
                component: Arc::new(AtomicU16::new(COMPONENT_RTP as u16)),
                network_type: Arc::new(AtomicU8::new(NetworkType::Tcp6 as u8)),
                tcp_type: TcpType::SimultaneousOpen,
                ..Default::default()
            },
            1860173823,
...
fn test_candidate_foundation() -> Result<(), Error> {
    ...
    assert_ne!(
        ...
        (CandidateBase {
            candidate_type: CandidateType::Host,
            network_type: Arc::new(AtomicU8::new(NetworkType::Udp6 as u8)),
            address: "A".to_owned(),
            ..Default::default()
        })
        .foundation(),
...
async fn test_candidate_marshal() -> Result<(), Error> {
    ...
    for (candidate, marshaled) in tests {
        let actual_candidate = unmarshal_remote_candidate(None, marshaled.to_owned()).await;
