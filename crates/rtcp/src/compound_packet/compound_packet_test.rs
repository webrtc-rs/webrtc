...
mod test {
    ...
    static ref REAL_PACKET:Vec<u8> = vec![
        ...
        0x65, 0x65, 0x65, 0x36, 0x39, 0x66, 0x35, 0x7d, // text="{9c00eb92-1afb-9d49-a47d-91f64eee69f5}"
    ...
    fn test_bad_compound() {
        ...
        match compound.validate() {
            ...
            Err(e) => {
                let a = ERR_BAD_FIRST_PACKET.to_owned();
                assert_eq!(
                    e,
                    ERR_BAD_FIRST_PACKET.to_owned(),
    ...
    fn test_valid_packet() {
        ...
        let tests = vec![
            (
                ...
                Err(ERR_MISSING_CNAME.to_owned()),
            ),
            (
                "SDES / no cname",
                CompoundPacket(vec![
            ...
            (
                ...
                Err(ERR_PACKET_BEFORE_CNAME.to_owned()),
            ),
            (
                "just RR",
                CompoundPacket(vec![
